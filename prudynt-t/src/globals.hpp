...
#define NUM_VIDEO_CHANNELS 6  // two main (0/1), two sub (4/5).  2/3 not used // was 2
#define NUM_JPEG_CHANNELS 4  // two main (0/2), two sub (1/3) // was 2
...
extern std::shared_ptr<video_stream> global_video[NUM_VIDEO_CHANNELS];  // stream 0, 1, 4, 5.  2/3 not used
